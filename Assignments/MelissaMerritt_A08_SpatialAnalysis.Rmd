...
> ANSWER: The EPSG code of the Counties dataset is 4269. This is a geographic reference system. The Datum is North American Datum 1983. 
...
# We can use the the merge() function to combine the two dataframes shown in the "x =" and "y =" arguments. The by.x and by.y arguments let us define the attributes we want to use to join the data. 

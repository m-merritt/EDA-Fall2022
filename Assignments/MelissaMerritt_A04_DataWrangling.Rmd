...
#6
write.csv(O3_NC2018_select, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2018_processed.csv")
write.csv(O3_NC2019_select, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2019_processed.csv")
write.csv(PM25_NC2018_select, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2018_processed.csv")
write.csv(PM25_NC2019_select, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2019_processed.csv")
...
# Using rbind() function allows me to combine the data files because all the row names are the same. 

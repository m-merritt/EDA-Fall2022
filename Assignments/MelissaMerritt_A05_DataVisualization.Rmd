...
Chemistry_Nutrients_PeterPaul$sampledate <- as.Date(Chemistry_Nutrients_PeterPaul$sampledate, format = "%m/%d/%Y")
NiwotRidge_Litter$collectDate <- as.Date(NiwotRidge_Litter$collectDate, format = "%m/%d/%Y")

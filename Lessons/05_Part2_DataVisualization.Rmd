...
# change from one theme to another change background/grid lines/ etc. 
=======
>>>>>>> fc8c57328ec11d4acfebcceb37adf859baecba8b
```
...
#define a theme within ggplot() - themeclassic but change a few things (increase font size) and change the text elements and the legend position 
...
<<<<<<< HEAD
# you can set the theme within the definition of your plot 
# this is the first way of defining a theme - you can set the theme to be your theme 
...
<<<<<<< HEAD
#this plot is adding a horizontal line that crosses at 50 and 100 (geom_hline) - this is useful when your gridlines might not be useful at your specific plot 
# geom_text you can define where you want a point - and just want good to be printed out 
# hjust is just the horizontal alighnment 
# another point named moderate, and one where it is unhealthy 
#ylab - label that is more informative than ozone
#change the axis text - can angle and horizontal justification 
...
#these ^ are many of the different color packets 
...
#we will do the below section in the lab section. 
...
# how can you have multiple plots on a page 
# cowplots will allow you to arrange your plots 
=======
#install.packages("cowplot")
library(cowplot)
plot_grid(NvsP2, Nutrientplot, nrow = 2, align = 'h', rel_heights = c(1.25, 1))

...
<<<<<<< HEAD
# mu = 50 is the hypothesis, alternative is less (because that is how it is stated in the hypothesis) p value is less than 0.05, so we reject null hypothesis (go with alternative hypothesis)
...
<<<<<<< HEAD
#asking for a density plot in gray, and vertical line at 50 because that is the mean in question, the mean will 

# Format as a GLM
O3.onesample2 <- lm(Ozone ~ 1, EPAair)
O3.onesample2

# use lm function to find the mean of the series. we only get one coefficient which is the intercept term
=======
# Format as a GLM
O3.onesample2 <- lm(Ozone ~ 1, EPAair)
O3.onesample2
...
<<<<<<< HEAD
#this will give you both mean and the p-value. difference in means is not equal to zero
#to write as a GLM you need to change the question, we need to ask ourselves if year is a funtion of ozone 
...
<<<<<<< HEAD
#coefficient are statistical different from zero (a predictor) if p value is less than 0.05

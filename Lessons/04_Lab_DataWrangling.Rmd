...
<<<<<<< HEAD
NTL.phys.data.Tuesday.Lake.1990thru1999 <- NTL.phys.data %>% 
...
<<<<<<< HEAD
> Answer: we don't filter using row numbers because we are basing these filters on column values. 
=======
> Answer: 
>>>>>>> fc8c57328ec11d4acfebcceb37adf859baecba8b
...
<<<<<<< HEAD
NTL.phys.data.Tuesday.Lake.1990thru1999.july <- NTL.phys.data.Tuesday.Lake.1990thru1999 %>%
  filter(daynum>181 & daynum<213)

#you could also do 
#NTL.phys.data.Tuesday.Lake.1990thru1999.july <- NTL.phys.data (lakename == "Tuesday Lake" & #year4>=1990 & year4<=1999 & month(sampledate=7))
...
<<<<<<< HEAD
Mean.surface.temp <- NTL.phys.data.Tuesday.Lake.1990thru1999.july %>%
  filter(depth==0) %>%
  summarise(meantemp = mean(temperature_C))

#also you could do 
#NTL.phys.data.ex4 <-
#NTL.phys.data.Tuesday.Lake.1990thru1999.july %>%
#filter(depth==0) %>%
...
<<<<<<< HEAD
NTL.phys.data.gathered <- pivot_longer(NTL.phys.data, irradianceWater:irradianceDeck)
=======
>>>>>>> fc8c57328ec11d4acfebcceb37adf859baecba8b
